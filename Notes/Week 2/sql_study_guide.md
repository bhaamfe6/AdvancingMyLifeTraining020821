...
- Schema
    - The structure of your database
        - contains tables, functions, indicies, etc
...
- SQL language and sublanguages
    ...
    - ALTER: alter the structure of an object (like tables)
        - add columns
        - add contraints
        - remove columns/contraints
        - etc.
    -TRUNCATE
        - removes data from a table, but does not delete the table itself
    - CREATE
        - used to create a new table and define a structre for that table (columns and their datatypes, constraints)
    - DROP
        - delete a table
    ...
    - DQL (Data query language)
        - SELECT
            ...
            - Some people consider it to be a separate sublange
    - DCL (Data congtrol language)
        - GRANT
        - REVOKE
...
- Joins
    ...
    - Conceptual types
        ...
        - Theta-join: a join where the conditin is not based on equality (ex. post.user_id > user.id)
    -Set Operations
...
- Connection Parameters
    - Connection String (URL)
        - `jdbc:postgresql://<enter host name here>:<enter port here>/<enter database name here>`
    - Your username
    - Your password
