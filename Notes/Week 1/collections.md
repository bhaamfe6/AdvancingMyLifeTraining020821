...
- `Set` : a collection that does not contain duplicate elements. If you try to add an element that already exists in the Set, it will simply not add it. (The elements are not necessarily order, except in the case of TreeSet.)
...
- Collection: is the interface that all of the collections, except may, inherit from 
